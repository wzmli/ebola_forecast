...
gg3 <- (ggplot(forecastdat, aes(date,med))
	...
	+ geom_point(data=filter(dat,date<= as.Date("2026-08-07")),aes(date,value),color="black",size=0.8)
	+ geom_point(data=filter(dat,date> as.Date("2026-08-07")),aes(date,value),color="red",size=0.8)
